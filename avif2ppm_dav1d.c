/* avif2ppm_dav1d.c - decode AVIF to PPM using libdav1d reference */
/* Compile: cc -std=c89 -DSTB_AVIF_USE_DAV1D -I~/.local/include ... -L~/.local/lib -ldav1d */
/* Usage:   ./avif2ppm_dav1d input.avif output.ppm [channels] */
